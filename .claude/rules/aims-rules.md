...
| `RcInc` | TF-N/A | — | — | — | — | — | — | — |
| `RcDec` | TF-N/A | — | — | — | — | — | — | — |
| `Set` | TF-15 | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` |
| `SetTag` | TF-15a | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` | `state(obj)` |
