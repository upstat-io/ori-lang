...
- **Non-aliasing definitions** (`Construct`, `Apply`, `PartialApply`, `Reuse`, `Select`, etc.): step (1) has no backward transfer — the destination's demand does not flow to its arguments. Only step (2) applies.
