...
- [ ] `[BUG-04-045][high]` **`is_cross_compiling()` reports native Apple Silicon as cross-compilation: `arm64` (LLVM triple) vs `aarch64` (Rust `cfg`) string mismatch** — found by manual.
