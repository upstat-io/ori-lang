...
- [ ] `[BUG-02-008][high]` **PC-2 violation: nested generic function calls leave fresh instantiation `Tag::Var`s unbound in generic source bodies** — surfaced by §03 validator wiring.
