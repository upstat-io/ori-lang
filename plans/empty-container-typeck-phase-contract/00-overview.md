...
| 08 | **Codegen Poly-Lambda Monomorphization (absorbs BUG-04-042, JIT-only scope per 2026-04-19 TPR-08-R4-01 resolution)** | `section-08-codegen-poly-lambda.md` | **Complete 2026-04-20** — all subsections closed: §08.1/08.1.5/08.2/08.3/08.3b/08.3b.1/08.3c/08.4/08.5/08.H/08.R/08.N; §08.6 `blocked-on-04` per §08.N option (b), cross-link annotation landed on §04.2 for future §04 implementer coordination. LLVM backend spec run GREEN (no CRASHED), +538 passing / −537 lc_fail vs pre-§08 baseline. AOT integration tests (BUG-04-AOT-MONO) are a sibling scope, unchanged. |
