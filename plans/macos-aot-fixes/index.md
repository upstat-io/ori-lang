...
|---------|-------|--------|----------|
| 01 | ARC merge-edge scoped cleanup (exit 1) | not-started | Major |
| 02 | Trampoline map str identity SIGSEGV (exit -139) | not-started | Critical |
| 03 | CI cross-platform timeout | not-started | Minor |
