...
- [ ] `/tpr-review` passed (final, full-section) — independent codex review clean or findings triaged. Note: this is still the single-source /tpr-review — the dual-source rewrite is Section 04, which has not yet landed.
