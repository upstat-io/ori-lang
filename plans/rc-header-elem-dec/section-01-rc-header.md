...
- [ ] Valgrind clean on existing heap-allocating tests — 57/62 pass as of 2026-03-20; 5 COW/TRMC failures remain:
  ...
  - [ ] `tests/valgrind/cow/cow_sharing.ori` — 1 invalid free (COW double-free on shared buffer)
  - [ ] `tests/valgrind/trmc/trmc_tree_ops.ori` — 360 invalid reads (TRMC tree traversal accessing freed memory)
