...
|----|-------|------|--------|
| 01 | C Personality Function | `section-01-personality-fn.md` | Complete |
| 02 | Codegen Integration | `section-02-codegen-integration.md` | Complete |
| 03 | Ori Exception Raise | `section-03-exception-raise.md` | Complete |
| 04 | Native Exception Catch | `section-04-exception-catch.md` | Complete |
