...
**File:** `section-03-cross-backend-dry.md` | **Status:** Complete (1 item blocked by roadmap-21A)
...
**File:** `section-06-llvm-internal-dry.md` | **Status:** Complete
...
**File:** `section-07-runtime-rc-protocol.md` | **Status:** Complete
...
**File:** `section-08-invariant-contracts.md` | **Status:** Complete
...
**File:** `section-09-registration-sync.md` | **Status:** Complete
...
**File:** `section-10-scattered-knowledge.md` | **Status:** Complete
...
**File:** `section-11-stale-annotations.md` | **Status:** Complete
...
**File:** `section-12-surface-hygiene.md` | **Status:** Complete
