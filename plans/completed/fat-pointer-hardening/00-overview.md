...
|----|-------|------|--------|
| 01 | Iterator–Collection Ownership Contract | `section-01-iterator-ownership.md` | Complete |
| 02 | Monomorphization of Captured Types | `section-02-monomorphization.md` | Complete |
| 03 | Aggregate Value Emission | `section-03-aggregate-emission.md` | Complete |
| 04 | Combinatorial Test Matrix | `section-04-test-matrix.md` | Complete |
