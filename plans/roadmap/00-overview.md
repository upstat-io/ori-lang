...
Section 18 (Const Generics) ──→ Section 20 (Compile-Time Reflection) ──→ Section 20A (Compile-Time Construction)
...
- Section 20A (Compile-Time Construction) requires Section 20 (uses fields_of, $for, $FieldMeta from reflection)
