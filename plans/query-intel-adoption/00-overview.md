...
Phase 2 - Fan-out  (parallelizable)  [CRITICAL PATH for adoption coverage]
  ...
  ├─ Section 06: Plan-schema mandatory Intelligence Reconnaissance subsection
  └─ Section 07: pre-review-intel.sh hook + settings.json registration

Phase 3 - Tool UX polish  (fully parallel)
...
| 06 Plan-schema recon | ~200 | Medium | 03 |
| 07 pre-review-intel hook | ~240 | Medium | 03 |
| 08 Tool UX + output | ~320 | High | — |
| **Total plan text** | **~1790** | | |
| **Total files touched (plan execution)** | **~35** | | |
...
| LEAK:algorithmic-duplication — intel pre-query pattern inlined in 6 review-family files | No SSOT helper exists yet | Section 03 | Not Started |
