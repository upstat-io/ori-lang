...
**Plan corpus**: `python scripts/plan_corpus.py check <path>` (validate plan frontmatter) | `discover` (full corpus report) | `docgen` (generate schema reference) | `docgen --check` (drift gate)
