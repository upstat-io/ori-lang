...
readonly CONFORMANCE_MAP=(
    "RL-1|SHIPPED|compiler/ori_arc/src/aims/class_ledger/emit/incs.rs"
    "RL-2|SHIPPED|compiler/ori_arc/src/aims/class_ledger/emit/releases.rs"
    "RL-3|SHIPPED|compiler/ori_arc/src/aims/realize/decide.rs"
    "RL-4|SHIPPED|compiler/ori_arc/src/aims/class_ledger/emit/releases.rs"
    "RL-5|SHIPPED|compiler/ori_arc/src/aims/class_ledger/emit/releases.rs"
    ...
    "RL-14|TARGET|allocation-lifetime-fact-freeze"
    "RL-14a|TARGET|exact-cleanup-fact-freeze"
    "RL-15|TARGET|representation-owned-extent-input"
    "RL-15a|TARGET|exact-caller-extent-fact-freeze"
    "RL-16|TARGET|conservative-allocation-fact-default"
    "RL-17|TARGET|dynamic-owner-bound-fact-freeze"
    "RL-18|TARGET|layout-capability-satisfaction"
    "RL-18a|TARGET|vm-compiled-logical-trace-parity"
    "RL-19|TARGET|thread-reachability-fact-freeze"
    "RL-20|TARGET|target-owned-thread-capability"
    "RL-21|TARGET|whole-program-no-thread-boundary-proof"
    ...
    "RL-29|TARGET|neutral-fact-export"
    "RL-30|TARGET|neutral-fact-export"
    "RL-31|TARGET|neutral-fact-export"
