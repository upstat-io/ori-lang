...
THEOREM_MAP: dict[str, tuple[str, str, list[str]]] = {
    ...
    # TF — Transfer.lean
    "TF-2a": ("Transfer", "TF2a_scalar_primitive_transfer", ["PrimitiveOperandUse", "transferPrimitive", "scalar"]),
    "TF-2b": ("Transfer", "TF2b_dual_consume_rows_preserve_one_result_owner", ["PrimitiveStrategy", "consumedInputs", "producedOwnerCount"]),
    ...
    "TF-11": (
        "Transfer",
        "TF11_raw_demand_timing_sound",
        ["RawDemand", "seqAdd", "foldl", "observe"],
    ),
    "TF-13": ("Transfer", "TF13_capture_state_update_monotone", ["AimsState", "le"]),
    "TF-14": (
        "Transfer",
        "TF14_project_demand_sound",
        [
            "ScalarLiveness",
            "ProducerDomainLaws",
            "RawDemand",
            "scalarProjectContribution",
            "cardinality",
            "locality",
        ],
    ),
    ...
    "RL-14": (
        "Realization",
        "lifetime_from_locality_sound",
        ["lifetimeFromLocality", "LifetimeBound"],
    ),
    "RL-14a": (
        "Realization",
        "cleanup_complete_on_normal_and_unwind",
        ["cleanupCoversNormalAndUnwind", "CleanupObligation"],
    ),
    "RL-15": (
        "Realization",
        "extent_class_is_repr_owned",
        ["ProjectionInput", "ExtentClass"],
    ),
    "RL-15a": (
        "Realization",
        "caller_extent_sites_complete",
        ["CallerUse", "callerExtent"],
    ),
    "RL-16": (
        "Realization",
        "freeze_allocation_facts_total_conservative",
        ["freezeAllocationFacts", "unknownAllocationFacts"],
    ),
    "RL-17": (
        "Realization",
        "owner_bound_is_dynamic_upper_bound",
        ["ownerBound", "ownerCapacity"],
    ),
    "RL-18": (
        "Realization",
        "validated_vm_plan_sound",
        ["Satisfies", "ValidatedVmPlan"],
    ),
    "RL-18a": (
        "Realization",
        "vm_compiled_event_parity",
        ["vmPlanTrace", "compiledPlanTrace"],
    ),
    "RL-19": (
        "Realization",
        "thread_reachability_from_locality_callgraph",
        ["threadReachabilityFrom", "ThreadReachability"],
    ),
    "RL-20": (
        "Realization",
        "potentially_shared_requires_safe_capability",
        ["potentiallyShared", "sharedSafe"],
    ),
    "RL-21": (
        "Realization",
        "no_thread_boundary_all_confined",
        ["programThreadReachability", "confined"],
    ),
    ...
    "RL-29": (
        "Realization",
        "RL29_neutral_fresh_self_allocation_decision",
        ["FreshSelfAllocationFact", "returnsFreshSelfAlloc"],
    ),
    "RL-30": (
        "Realization",
        "RL30_neutral_memory_access_decision",
        ["MemoryAccessFact", "mayWriteInaccessible"],
    ),
    "RL-31": (
        "Realization",
        "RL31_neutral_parameter_disjointness_sound",
        ["ArgProvenance", "rootSet"],
    ),
    ...
    "VF-3": (
        ...
        ["RealizedParamEvidence", "oracleAccepts", "iterTransferAgrees", "vf3_safe"],
    ),
    ...
    "IC-T4": (
        "ContractBoundary",
        "T4_contract_boundary_and_result_plan_sound",
        [
            "boundaryInstrs",
            "calleeConforms",
            "invokeBoundaryEvents",
            "FunctionExitInventory",
            "FrozenFunctionResultPlan",
            "borrowedIndirectCallableRowEvents",
        ],
    ),
    ...
    "IA-5-step-1": (
        "Transfer",
        "IA5_step1_and_raw_block_walk_sound",
        ["IA5Step1Instr", "ia5Step1Conforms", "RawDemand", "foldl"],
    ),
...
COMPOSITION_FOLDED = {
    ...
    "RL-1-RL-2-composition", "CN-Ordering", "CN-Fixpoint-OneRound",
