...
## AOT Runtime Memory Management

For AOT runtime memory management (reference counting, COW collections, SSO strings, data structure layouts), see [Runtime](../11-runtime/index.md).
