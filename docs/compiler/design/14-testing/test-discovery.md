...
- [Testing System Overview](index.md) -- architecture, test types, attributes, outcomes, and the overall design philosophy behind Ori's mandatory testing requirement
