...
This is the reference documentation for Ori's standard library — the modules that ship with every Ori installation.
...
Ori uses dot-separated module names:
...
The [prelude](prelude.md) contains items automatically imported into every Ori program:
...
This documentation is for Ori **0.1-alpha**.
