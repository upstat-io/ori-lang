...
This document covers defining and working with error types in Ori: user-defined errors, the standard `Error` type, error conversion, and best practices.

---

## Philosophy

Ori encourages **precise, matchable error types**:
...
Ori provides a built-in `Error` type for when you don't need precise error information:
