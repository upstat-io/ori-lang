---
title: "Patterns"
description: "Clause 15: Ori Language Specification — Patterns"
order: 15
section: "Language"
---
...
> **Grammar:** See [grammar.ebnf](grammar.md) § PATTERNS
...
NOTE  Data transformation (`map`, `filter`, `fold`, `find`, `collect`) and resilience (`retry`, `validate`) are stdlib methods, not compiler patterns. See [Built-in Functions](annex-c-built-in-functions.md).
...
> **Grammar:** See [grammar.ebnf](grammar.md) § at_pattern
...
Concurrency patterns create tasks. See [Concurrency Model](22-concurrency-model.md) for task definitions, async context semantics, and capture rules.
...
See [nursery](#1544-nursery) for cancellation semantics and `CancellationError` type.
...
See [Errors and Panics § Catching Panics](17-errors-and-panics.md#174-catching-panics).
...
See [Types § Iterator Traits](08-types.md#813-iterator-traits) for trait definitions.
