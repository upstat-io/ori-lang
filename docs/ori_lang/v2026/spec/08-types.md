---
title: "Types"
description: "Clause 8: Ori Language Specification — Types"
order: 8
section: "Language"
---
...
> **Grammar:** See [grammar.ebnf](grammar.md) § TYPES
...
When calling a function with const bounds, the caller's bounds shall _imply_ the callee's bounds. The compiler performs linear arithmetic implication checking:
...
> **Grammar:** See [grammar.ebnf](grammar.md) § DECLARATIONS (type_def)
...
> **Grammar:** See [grammar.ebnf](grammar.md) § TYPES (impl_trait_type)
