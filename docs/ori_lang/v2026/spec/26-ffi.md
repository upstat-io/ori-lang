...
> **Grammar:** See [grammar.ebnf](grammar.md) § DECLARATIONS (extern_block)
...
> **Grammar:** See [grammar.ebnf](grammar.md) § FFI (`param_modifier`)
...
> **Grammar:** See [grammar.ebnf](grammar.md) § FFI (`ownership`)
