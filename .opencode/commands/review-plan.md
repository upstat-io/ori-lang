...
3. Draft a list of inaccuracies with proposed fixes
...
Questions:
1. Did I miss any inaccuracies? Read the plan and codebase to check.
...
**Apply**: Once consensus is reached, edit the plan files to apply all agreed accuracy fixes.
...
**Apply**: Edit the plan files to add all agreed completeness fixes.
...
6. Audit against hygiene rules: BLOAT, WASTE, DRIFT, EXPOSURE, LEAK, STYLE
7. Draft cleanup items to weave into the plan
...
**Apply**: Edit the plan files to apply hygiene fixes and weave in cleanup items.
...
**Apply**: Edit the plan files with all agreed clarity fixes.
