//! Smoke tests for `validate_drop_partial_move` (E2048) — full coverage lives
//! in the spec-test corpus at `tests/spec/aims/`, which exercises
//! the validator end-to-end via `#compile_fail("E2048")` directives.

use ori_ir::{ExprId, Name};
use rustc_hash::FxHashMap;

use super::validate_drop_partial_move;
use crate::{Pool, TraitRegistry};
