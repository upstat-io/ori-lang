...
static LIST_METHODS: &[MethodDef] = &[
    ...
    MethodDef::compound("enumerate",   &[],                   IDX_PAIRS, None,               Ownership::Borrow, false),
    ...
    MethodDef::compound("flatten",     &[],                   FRESH,     None,               Ownership::Borrow, true),
    ...
    MethodDef::compound("to_dynamic",  &[],                   LIST_ELEM, None,               Ownership::Owned,  false),
    MethodDef::compound("to_fixed",    &[],                   LIST_ELEM, None,               Ownership::Owned,  false),
