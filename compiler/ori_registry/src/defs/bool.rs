...
pub static BOOL: TypeDef = TypeDef {
    ...
    operators: OpDefs {
        ...
        eq: OpStrategy::BooleanLogic,
        neq: OpStrategy::BooleanLogic,
        lt: OpStrategy::UnsignedComparison,
        gt: OpStrategy::UnsignedComparison,
        lt_eq: OpStrategy::UnsignedComparison,
        gt_eq: OpStrategy::UnsignedComparison,
        neg: OpStrategy::Unsupported,
        not: OpStrategy::BooleanLogic,
