...
//! `DerivedMethodShape`, `DerivedMethodInfo`, and derivation [`strategy`] types. These
//! are used by the type checker, evaluator, and LLVM codegen. Their `ori_ir`
//! location keeps consuming crates acyclic.
//!
...
use super::strategy::{CombineOp, DeriveStrategy, FieldOp, FormatOpen, StructBody, SumBody};
    ...
    pub fn strategy(&self) -> DeriveStrategy {
        match self {
            ...
            DerivedTrait::Printable => DeriveStrategy {
                struct_body: StructBody::FormatFields {
            ...
            DerivedTrait::Default => DeriveStrategy {
                struct_body: StructBody::DefaultConstruct,
                sum_body: SumBody::NotSupported,
            },
