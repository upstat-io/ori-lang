...
//! suppression. The nested-construct transitive lineages + their escape /
//! borrow-view vetting gates live in [`nested`]. Spec: Annex E §AIMS
//! RL-5 + RL-4 + RL-2.
...
use nested::{collect_lineage_element_borrow_views, collect_nested_construct_owned_dead_lineages};
