//! Instruction and terminator formatting for the ARC IR.
//!
...
#[expect(clippy::unwrap_used, reason = "write! to String is infallible")]
pub fn fmt_value(out: &mut String, value: &ArcValue, interner: &StringInterner) {
    match value {
...
#[expect(clippy::unwrap_used, reason = "write! to String is infallible")]
pub fn fmt_literal(out: &mut String, lit: &LitValue, interner: &StringInterner) {
    match lit {
...
pub fn fmt_ctor(ctor: &CtorKind, interner: &StringInterner) -> String {
    match ctor {
...
#[expect(clippy::unwrap_used, reason = "write! to String is infallible")]
pub fn fmt_args_simple(out: &mut String, args: &[ArcVarId], func: &ArcFunction) {
    write!(out, "(").unwrap();
...
#[expect(clippy::unwrap_used, reason = "write! to String is infallible")]
pub fn fmt_args_with_ownership(
    out: &mut String,
    args: &[ArcVarId],
