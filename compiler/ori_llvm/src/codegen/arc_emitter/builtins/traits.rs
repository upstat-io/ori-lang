...
declare_builtins! { emitter, ctx;
    ...
    // equals / is_equal
    ("int", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("int", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "equals", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "is_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    // compare
    ("int", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "compare", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    // hash
    ("int", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "hash", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    // comparison predicates
    ("int", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("int", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("int", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("int", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("float", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("bool", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("char", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("byte", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Duration", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "is_less", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "is_greater", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "is_less_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    ("Size", "is_greater_or_equal", borrow: true) => emitter.emit_trait_method(ctx.method, ctx.arg_vals, ctx.type_info),
    // String trait methods (equals, compare, hash, comparison predicates)
    ("str", "equals", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "is_equal", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "compare", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "hash", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "is_less", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "is_greater", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "is_less_or_equal", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    ("str", "is_greater_or_equal", borrow: true) => emitter.emit_str_trait_method(ctx.method, ctx.arg_vals),
    // Ordering trait methods
    ("Ordering", "equals", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "compare", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "hash", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "is_less", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "is_equal", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "is_greater", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "is_less_or_equal", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "is_greater_or_equal", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
    ("Ordering", "reverse", borrow: true) => emitter.emit_ordering_method(ctx.method, ctx.arg_vals),
}
