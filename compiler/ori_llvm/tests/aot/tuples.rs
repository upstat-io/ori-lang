...
#[test]
#[ignore = "BUG-01-024: Parser gap — chained tuple field access t.0.0 lexed as float"]
...
#[test]
#[ignore = "BUG-01-024: Parser gap — chained tuple field access t.1.0 lexed as float"]
